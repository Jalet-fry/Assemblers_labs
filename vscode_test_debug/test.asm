...
.data                  
  ...
  ; сообщения об ошибках
    ...
    cmd_off dw offset cmd_text                     ; Смещение командной строки
    cmd_seg dw 0                                     ; Сегмент командной строки
    fcb1 dd 0                                        ; FCB (File Control Block) 1
    fcb2 dd 0                                        ; FCB (File Control Block) 2
...
start:
    ...
    ; push es
    mov ax, @data            ; Загружаем адрес сегмента данных
    mov es, ax               ; Устанавливаем DS на сегмент данных
